...
with expected_snapshots(as_of_date, layer, category, expected_count) as (
    values
        (date '2026-07-15', 'promoted', 'all', 557067),
        (date '2026-08-05', 'promoted', 'all', 557291),
        (date '2026-08-19', 'promoted', 'all', 557211),
        (date '2026-07-15', 'disposition', 'keyed', 247441),
        (date '2026-08-05', 'disposition', 'keyed', 248077),
        (date '2026-08-19', 'disposition', 'keyed', 248215),
        (date '2026-07-15', 'snapshot', 'delinquent', 5476),
        (date '2026-08-05', 'snapshot', 'delinquent', 13169),
        (date '2026-08-19', 'snapshot', 'delinquent', 13071)
),
actual_snapshots as (
...
expected_transitions(from_as_of_date, to_as_of_date, category, expected_count) as (
    values
        (date '2026-07-15', date '2026-08-05', 'entry', 7750),
        (date '2026-07-15', date '2026-08-05', 'still', 5411),
        (date '2026-07-15', date '2026-08-05', 'newly_observed_delinquent', 8),
        (date '2026-07-15', date '2026-08-05', 'named_movement', 7737),
        (date '2026-08-05', date '2026-08-19', 'entry', 2),
        (date '2026-08-05', date '2026-08-19', 'exit', 104),
        (date '2026-08-05', date '2026-08-19', 'still', 13065)
),
...
select 'fixture' as layer, 'identity_free' as category, date '1900-01-01' as as_of_date,
